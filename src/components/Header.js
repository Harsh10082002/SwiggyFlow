...
const HeaderComponent = () => {
    ...
    const [themeClass, setThemeClass] = useState("nav");
    ...
    <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
      {/* this contains all the links part */}
      ...
      */}
        ...
        <h3 className="font-bold text-emerald-50 px-4">{data.userName} </h3>
        <Link to="/cart" ><h3 className="font-bold text-emerald-50 px-4">Cart - {cartData.length}</h3></Link>
